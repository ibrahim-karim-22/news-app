...
})({"fvoPF":[function(require,module,exports) {
...
const apiKey = "94e1bef6b40b4a9bb5b3df50dfd22d34";
...
By using toLocaleString(), you ensure that the publishing date is presented in a format that is easy to read and understand for users in different regions. It automatically adapts to the user's locale settings, providing a more user-friendly experience. */ //its better to use conditional if to make sure if author or source and source name not present it just wouldnt show it
...
},{}]},["fvoPF","f47v6"], "f47v6", "parcelRequire7309")
